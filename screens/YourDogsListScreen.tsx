...
export const YourDogsListScreen = ({ navigation }) => {
    ...
    const renderDogCards = () =>{
      ...
      return Object.entries(dogs.data).map(([id, dog]) => (
        <TouchableOpacity onPress={() => navigation.navigate('AddDogScreen', {...dog, id})} style={dog.isActive ? styles.dogCard : styles.dogCardInactive} key={id}>
